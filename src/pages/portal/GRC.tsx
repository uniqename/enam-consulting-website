...
export default function GRC() {
  const risks = [
    { title: 'Key Person Risk', severity: 'high', probability: 'Medium', impact: 'High', status: 'monitored' },
    { title: 'Cash Flow Volatility', severity: 'medium', probability: 'Medium', impact: 'Medium', status: 'mitigating' },
    { title: 'Data Security Gaps', severity: 'medium', probability: 'Low', impact: 'High', status: 'monitored' },
  ];
