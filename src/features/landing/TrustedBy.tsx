import ChamberMembershipBadge from '../../components/ChamberMembershipBadge';
...
const TrustedBy = () => {
  return (
    <>
      ...
      <section className="py-12 bg-stone-50 border-b border-stone-100 w-full">
        <div className="w-full px-6 text-center">
          <p className="text-sm font-semibold text-stone-400 uppercase tracking-widest mb-8">Community & Professional Memberships</p>
